# -*- coding: utf-8 -*-
"""
Created on Sun May 10 09:46:58 2020
...
from lstm_utils import load_training, my_LSTM, DataSequence
...
if train_full_model:
    ...
    save_weights = True
    if save_weights:
        checkpoint_dir = '.\\training_checkpoints\\stacked_lstm_2_full'
...
#~~~~~~~~~~~~~~~~~~~~~~~
close_input = log_close[:-1].reshape(1, log_close.shape[0]-1, 1)

# Get Residuals
#~~~~~~~~~~~~~~
residuals = log_close[1:] - full_model(close_input).numpy().reshape(close_input.shape[1])
...
if train_test_model:
    ...
    save_weights = True
    if save_weights:
        checkpoint_dir = '.\\training_checkpoints\\stacked_lstm_2_test'
        checkpoint_prefix = os.path.join(checkpoint_dir, "model_ckpt")
...
#~~~~~~~~~~~~~~~~~~~~~~
log_pred_close = test_model.get_prediction(training_close_input, steps = validation_size)
...
# predictions
pred_close =  InvBoxCox(log_pred_close)
